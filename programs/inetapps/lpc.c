...
void main(int argc, char *argv[]) {
	...
	char *printer;
       ...
       if (argc>2) {
		...
		fprintf(stream,"%c%s lp",6,printer);
		free(printer);
	...
	printf("Usage: %s <[queuename@]servername> <key> [options]\n", argv[0]);	
	printf("key,options: http://www.lprng.com/LPRng-HOWTO/LPRng-HOWTO.html#LPCREREAD\n");	
}
