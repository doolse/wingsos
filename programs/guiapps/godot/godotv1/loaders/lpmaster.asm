...
; ----------------------------------- Equates
            ...
            .eq flen		=$bd20	; /$bd21: filelength
            .eq load		=$ffd5	; kernal LOAD 
...
ps0         jsr onebyte		; get second byte (of Printshop file)
            bne jerror
            sta gbyte
...
gf0         lda ls_nambuf,x
            ...
            ldy #$bd
            sei
            jsr load		; execute LOAD, filelength at $bd20
            cli
            jmp gd_spron	; pointer on
