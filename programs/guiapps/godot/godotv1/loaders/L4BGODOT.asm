...
; note: clips larger than 320x200 aren't yet supported and crash
; GoDot)
...
getbbr      stx brmerk		; save width
            txa
            clc
            adc sc_lastclpzl+1	; width plus start to wide?
            cmp rrand
            bcc gbh2
